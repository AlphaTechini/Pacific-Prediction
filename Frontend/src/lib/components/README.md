...
- To find navigation chrome visit [TopNavBar.svelte](file:///C:/Hackathons/Pacific%20Prediction/Frontend/src/lib/components/TopNavBar.svelte).
...
- The top navigation component can be found in [TopNavBar.svelte](file:///C:/Hackathons/Pacific%20Prediction/Frontend/src/lib/components/TopNavBar.svelte).
